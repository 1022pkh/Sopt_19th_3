package com.semi.sopt_19th_3.upgrade2;
...
public class UpgradeList2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upgrade_list2);
        ...
        adapter = new ArrayAdapter(getApplicationContext(),android.R.layout.simple_list_item_1,mDatas);
        ...
        inputTitle = (EditText)findViewById(R.id.titleEdit);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(inputTitle.length() !=0 ){
                    ...
                    mDatas.add(inputTitle.getText().toString());
                    // listview 갱신
                    adapter.notifyDataSetChanged();

                    Toast.makeText(getApplicationContext(),"항목 추가 완료!",Toast.LENGTH_SHORT).show();
                    inputTitle.setText("");
                }
                else
